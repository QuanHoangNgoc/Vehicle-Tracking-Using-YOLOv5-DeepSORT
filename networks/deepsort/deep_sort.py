...
class DeepSort(object):
    ...
    def update(self, bbox_xyxy, confidences, ori_img): #!!! #!!! #!!!
        ...
        for track in self.tracker.tracks:
            ...
            track_feat = track.get_features()
            score = track.get_confidence_score() 
            
            outputs.append(np.array([x1,y1,x2,y2,track_id, track_feat, score], dtype=np.int64)) #!!! I changed 
    ...
    def _xyxy_to_xywh(self, bbox_xyxy):
        ...
        bbox_xywh[:,2] = bbox_xyxy[:,2] - bbox_xyxy[:,0] #w
        bbox_xywh[:,3] = bbox_xyxy[:,3] - bbox_xyxy[:,1] #h

...
if __name__ == '__main__':
    ...
    # If you not use any weight and want to use pretrained on COCO, un comment these lines
    MAPPING_DICT = {
        0: 0,
        1: 0,
        2: 1,
...
''' 
I changed 
python run.py --input_path='D:\cd_data_C\Desktop\CT\main\demo\sample\cam_04.mp4' --output_path="D:\cd_data_C\Desktop\CT\results" --weight="D:\cd_data_C\Desktop\CT\yolov5s.pt"
''' 